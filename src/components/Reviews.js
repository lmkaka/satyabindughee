  ...
  const reviewsData = [
    {
      ...
      review: {
        ...
        hi: 'मैंने हाल ही में SB प्रीमियम घी खरीदा है, और मैं इसकी गुणवत्ता से बहुत प्रभावित हूं। इस घी का रंग समृद्ध, सुनहरा है और इसकी सुगंध अद्भुत है। यह मेरे व्यंजनों में अतुलनीय स्वाद जोड़ता है। बनावट चिकनी और मलाईदार है, जो खाना पकाने के लिए एकदम सही है। मुझे यह पसंद है कि यह उच्च गुणवत्ता वाली, घास खिलाई गई गायों से बनाया गया है। यह कुछ अन्य ब्रांडों की तुलना में थोड़ा महंगा है, लेकिन बेहतर गुणवत्ता कीमत को उचित ठहराती है। प्रामाणिक, प्रीमियम घी को महत्व देने वाले किसी भी व्यक्ति के लिए अत्यधिक अनुशंसित।'
      },
      rating: 5,
      date: '11/09/2025',
      product: {
    ...
    },
    {
      ...
      review: {
        ...
        hi: 'पिछले 3 महीनों से SB प्रीमियम घी का उपयोग कर रहे हैं और मेरा पूरा परिवार इसे पसंद करता है! खाना पकाते समय खुशबू दिव्य है। मेरी रोटियां बेहतर स्वाद लेती हैं, दाल अधिक स्वादिष्ट होती है। पैकेजिंग भी बहुत अच्छी है - कोई रिसाव की समस्या नहीं। हर पैसे के लायक!'
      },
      rating: 5,
      date: '11/05/2025',
      product: {
    ...
    },
    {
      ...
      review: {
        ...
        hi: 'मैं अपनी माँ के स्वास्थ्य के लिए शुद्ध A2 गाय का घी खोज रहा था। SB प्रीमियम घी वही है जो मैं खोज रहा था। पहले चम्मच से ही अंतर महसूस होता है। अत्यधिक पचने योग्य और कोई कृत्रिम गंध नहीं। मेरी माँ का पाचन काफी सुधर गया है।'
      },
      rating: 5,
      date: '10/28/2025',
      product: {
    ...
    },
    {
      ...
      review: {
        ...
        hi: 'अंततः वह घी मिल गया जो मुझे मेरी दादी के घर के बने घी की याद दिलाता है! बिलोना विधि वास्तव में फर्क लाती है। दानेदार बनावट और मेवे जैसा स्वाद एकदम सही है। मैं इसे अपनी सुबह की कॉफी में उपयोग करता हूं और यह पूरे दिन अद्भुत ऊर्जा देता है।'
      },
      rating: 5,
      date: '10/22/2025',
      product: {
    ...
    },
    {
      ...
      review: {
        ...
        hi: 'एक फिटनेस उत्साही के रूप में, मैं बिना किसी मिलावट के शुद्ध घी की तलाश में था। SB प्रीमियम घी मेरी पसंदीदा पसंद बन गया है। इसका स्वाद साफ है, कीटो डाइट के लिए एकदम सही। 5kg पैक मेरे जैसे नियमित उपयोगकर्ताओं के लिए बहुत किफायती है।'
      },
      rating: 5,
      date: '10/18/2025',
      product: {
    ...
    },
    {
      ...
      review: {
        ...
        hi: 'मैं अपने बच्चों को स्वस्थ भोजन खिलाने के लिए संघर्ष कर रही थी। उनके भोजन में SB प्रीमियम घी का उपयोग करना शुरू किया और अब वे वास्तव में अधिक मांगते हैं! मीठी सुगंध और समृद्ध स्वाद सब कुछ स्वादिष्ट बनाता है। बच्चों वाले परिवारों के लिए बढ़िया उत्पाद।'
      },
      rating: 5,
      date: '10/15/2025',
      product: {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviewsData.map((review) => (
            ...
            >
              ...
              {/* "Read More" indicator */}
              {review.review[language].length > 150 && (
